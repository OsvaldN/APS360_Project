...
def plotter(model_name, train_losses, val_losses, save=False, show=True, loss_type='BCELoss'):
    '''
    Plots loss curves
...
def save_prog(model, model_path, train_losses, val_losses, epoch, save_rate):
    '''
